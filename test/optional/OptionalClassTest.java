...
public class OptionalClassTest {
    ...
    public void TestIspresent() {
        Optional<Language> lang = Optional
                .of(new Language(300000, "Scala"));
    ...
    public void TestIfPresent() {
        Optional<Language> maybeLang = Optional
                .of(new Language(2500000, "Java"));

        maybeLang.ifPresent(
                lang -> System.out.println("IfPresent: " + lang.name));
    ...
    public void TestSupplier() {
        ...
        Optional<Language> maybeLang = Optional.empty();
        Supplier<Language> defaulLanguage = () -> new Language(300000,
                "Scala");
